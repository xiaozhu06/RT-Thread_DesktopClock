...
#define GET_LOCAL_URI   "https://api.seniverse.com/v3/weather/now.json?key=S7IIXo8XrjHsXlXLq&location=nanyang&language=zh-Hans&unit=c"
...
MSH_CMD_EXPORT(http_client_weather,dawdawdas);
